...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a href="../Private_Message/Private_Message.php"><img src="../img/booth-file.png" class="navimg img-responsive" /><span class="nav-writting">Private Chat</span></a></li>
            ...
            <li><a style="border-left:4px collegebooth rgba(69, 162, 255, 0.93); border-radius:10px" href="#"><img src="../img/log-file-format-1.png" class="navimg img-responsive" /><span class="nav-writting">General Announcements</span></a></li>
